...
// And run these on startup and shutdown
extern void kbd_install();
extern void kbd_uninstall();

// Pointer to scanbuffer array, which you can read directly using the #defines further down
// Or you can use the handy macro
